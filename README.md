...
## Project Structure
    ...
    ├── testingapksss_dev_25996  # Django project configurations
...
1. Clone this repo and `cd testingapksss_dev_25996`
...
2. Clone this repo and `cd testingapksss_dev_25996`
